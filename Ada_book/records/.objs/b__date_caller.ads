...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_date_caller" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4b2dbc5f#;
   pragma Export (C, u00001, "date_callerB");
   ...
   u00126 : constant Version_32 := 16#bc9b9ed9#;
   pragma Export (C, u00126, "datesB");
   u00127 : constant Version_32 := 16#b5cd6489#;
   pragma Export (C, u00127, "datesS");
   u00128 : constant Version_32 := 16#4aa988d0#;
   pragma Export (C, u00128, "system__concat_2B");
   u00129 : constant Version_32 := 16#9f9c931f#;
   pragma Export (C, u00129, "system__concat_2S");
   u00130 : constant Version_32 := 16#1982dcd0#;
   pragma Export (C, u00130, "system__memoryB");
   u00131 : constant Version_32 := 16#f95ea4cd#;
