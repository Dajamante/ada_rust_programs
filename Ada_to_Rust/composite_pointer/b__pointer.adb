pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__pointer.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__pointer.adb");
...
package body ada_main is
   ...
   E106 : Short_Integer; pragma Import (Ada, E106, "ada__strings__text_buffers__unbounded_E");
   ...
   begin
      ...
      declare
         procedure F2;
         pragma Import (Ada, F2, "ada__strings__text_buffers__unbounded__finalize_spec");
      begin
         F2;
      end;
      E112 := E112 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_pointer");
...
--  BEGIN Object file/option list
   --   /workspaces/ada_rust_programs/Ada_to_Rust/composite_pointer//pointer.o
   --   -L/workspaces/ada_rust_programs/Ada_to_Rust/composite_pointer/
   --   -L/workspaces/ada_rust_programs/Ada_to_Rust/composite_pointer//
   --   -L/home/vscode/gnat/lib/gcc/x86_64-pc-linux-gnu/10.3.1/adalib/
   --   -static
   --   -lgnat
   --   -ldl
